...
public class RenderCi {
    public static void render(Font pFont, String ciCode, GuiGraphics guiGraphics, int pMouseX, int pMouseY){
        if (!ciCode.isEmpty()) {
            ...
            int j1 = 400;
            var textureEvent = net.neoforged.neoforge.client.ClientHooks.onRenderTooltipTexture(ItemStack.EMPTY, guiGraphics, l, i1, pFont, pComponents, null);
            TooltipRenderUtil.renderTooltipBackground(guiGraphics, l, i1, i2, j2, 400, textureEvent.getTexture());
            ...
            for (int l1 = 0; l1 < pComponents.size(); l1++) {
                ...
                clienttooltipcomponent1.renderText(pFont, l, k1, guiGraphics.pose().last().pose(), Minecraft.getInstance().renderBuffers().bufferSource());
            ...
            for (int k2 = 0; k2 < pComponents.size(); k2++) {
                ...
                clienttooltipcomponent2.renderImage(pFont, l, k1,clienttooltipcomponent2.getWidth(pFont),clienttooltipcomponent2.getHeight(pFont), guiGraphics);
