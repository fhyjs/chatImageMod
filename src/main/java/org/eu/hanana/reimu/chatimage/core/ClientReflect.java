...
public class ClientReflect {
    ...
    public static void closeTexture(Identifier texId, String texid){
    ...
    public static void clearCache() {
        for (Identifier value : BufferedTexture.values()) {
    ...
    public static void registerDynamicTexture(Identifier name ,NativeImage nativeImage){
