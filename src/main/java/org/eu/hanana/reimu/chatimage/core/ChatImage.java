...
public class ChatImage {
    ...
    public static final Map<String, Identifier> BufferedTexture = new HashMap<>();
    public URL url;
    ...
    public boolean viewRaw(boolean isRaw){
        ...
        if (getTexture()!=null){
            ...
            try {
                clientRClass.getMethod("closeTexture", Identifier.class,String.class).invoke(null,texId,getTextureId());
    ...
    public void downloadImg(){
        ...
        try {
            ...
            Identifier resourcelocation = Identifier.fromNamespaceAndPath(ChatimageMod.MOD_ID, "dynamic/ci/" + BufferedTexture.size());
            AtomicBoolean finish = new AtomicBoolean(false);
            AtomicReference<Throwable> error = new AtomicReference<>(null);
            //noinspection unchecked
            ((BlockableEventLoop<Runnable>) clientRClass.getMethod("getClientBlockableEventLoop").invoke(null)).schedule(()->{
                try {
                    clientRClass.getMethod("registerDynamicTexture", Identifier.class, NativeImage.class).invoke(null,resourcelocation,read);
