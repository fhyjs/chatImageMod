...
import org.eu.hanana.reimu.mc.hnnlib.url.HananaInternalUrlFactory;
...
//        }
    ...
    private void init(FMLCommonSetupEvent event){
        ...
        try {
            // 注册自定义的URL流处理器工厂
            HananaInternalUrlFactory.factories.add(new ChatimageURLStreamHandlerFactory());
            logger.info("URL.setURLStreamHandlerFactory success");
        }catch (Throwable e){
            try {
//                // 创建高权限 lookup
