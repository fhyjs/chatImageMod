package org.eu.hanana.reimu.mc.chatimage.mixininit;
...
@IFMLLoadingPlugin.Name(ChatImageMod.MODID)
...
public class EarlyMixinInit implements IFMLLoadingPlugin, IEarlyMixinLoader {
    ...
    public List<String> getMixinConfigs() {
        return Collections.singletonList("mixins.chatimage_early.json");
    }
