package org.eu.hanana.reimu.mc.chatimage.Event;
...
public abstract class RenderTooltipImageEvent extends Event
{
    @Nonnull
    protected final ChatImage image;
    protected int x;
    protected int y;
    protected FontRenderer fr;

    public RenderTooltipImageEvent( ChatImage chatImage, int x, int y, @Nonnull FontRenderer fr)
    {
     ...
     */
    @Cancelable
    public static class Pre extends RenderTooltipImageEvent
    {
        private int screenWidth;
        private int screenHeight;
        private int maxWidth;

        public Pre(ChatImage chatImage, int x, int y, int screenWidth, int screenHeight, int maxWidth, @Nonnull FontRenderer fr)
        {
            super(chatImage, x, y, fr);
     ...
     * </ul>
     */
    protected static abstract class Post extends RenderTooltipImageEvent
    {
        private final int width;
        private final int height;

        public Post(ChatImage chatImage, int x, int y, @Nonnull FontRenderer fr, int width, int height)
        {
            super(chatImage, x, y, fr);
            this.width = width;
            this.height = height;
    ...
    {
        public PostBackground(ChatImage chatImage, int x, int y, @Nonnull FontRenderer fr, int width, int height)
        { super(chatImage, x, y, fr, width, height); }
    }
    ...
    {
        public PostText(ChatImage chatImage, int x, int y, @Nonnull FontRenderer fr, int width, int height)
        { super(chatImage, x, y, fr, width, height); }
    }
     ...
     */
    public static class Color extends RenderTooltipImageEvent
    {
        ...
        public Color(ChatImage chatImage, int x, int y, @Nonnull FontRenderer fr, int background, int borderStart,
                     int borderEnd)
        {
            super(chatImage, x, y, fr);
